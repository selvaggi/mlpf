...
datasets = {
    "train": "/eos/user/m/mgarciam/datasets_mlpf/230923_20_25/pf_tree_1.root",
    "test": "/eos/user/m/mgarciam/datasets_mlpf/230923_20_25/pf_tree_1.root",
}
...
for i in tqdm(range(50)):
    ...
    hits_energy_ecal[key].append(np.array(hits_energy)[ecal_hits_filter].tolist())
    hits_energy_hcal[key].append(np.array(hits_energy)[~ecal_hits_filter].tolist())
...
fig.tight_layout()
fig.savefig(
    "/afs/cern.ch/work/m/mgarciam/private/mlpf/summ_results/220823_condor_spread_20_25_10k_energy_02.png"
)

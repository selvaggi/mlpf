...
datasets = {
    "train": "/eos/user/m/mgarciam/datasets_mlpf/condor/condor_dataset_test_large_restrictedE_1/1/tree.root",
    "test": "/eos/user/m/mgarciam/datasets_mlpf/condor/condor_dataset_test_large_restrictedE_1/1/tree.root",
}
...
class Args:
    def __init__(self, datasets):
        ...
        self.data_config = "/afs/cern.ch/work/m/mgarciam/private/mlpf/config_files/config_2_newlinks_predict.yaml"
...
for i in range(0, 5):
    ...
    g_i.ndata["pandora_cluster"][g_i.ndata["pandora_cluster"] == -1] = 0
    pandora_e = scatter_mean(
        g_i.ndata["pandora_cluster_energy"], g_i.ndata["pandora_cluster"].long()
    )
    print("pandora e", pandora_e)
    pandora_e_hits = scatter_sum(e_hits.view(-1), g_i.ndata["pandora_cluster"].long())
    print("pandora e reco", pandora_e_hits)

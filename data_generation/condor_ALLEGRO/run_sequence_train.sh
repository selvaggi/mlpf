...
if [ ! -f "out_reco_edm4hep_REC.parquet" ]; then
    ...
    python  -m preprocessing.dataset_creation_ALLEGRO --input  /eos/experiment/fcc/users/g/gmarchio/ALLEGRO_o1_v03/mlpf/condor/gun_dr_logE_v0_010925/${SEED}/out_reco_edm4hep.root  --outpath . 
fi

mkdir -p ${OUTPUTDIR}
python /afs/cern.ch/work/f/fccsw/public/FCCutils/eoscopy.py out_reco_edm4hep_0.parquet ${OUTPUTDIR}/pf_tree_${SEED}_0.parquet
python /afs/cern.ch/work/f/fccsw/public/FCCutils/eoscopy.py out_reco_edm4hep_1.parquet ${OUTPUTDIR}/pf_tree_${SEED}_1.parquet
python /afs/cern.ch/work/f/fccsw/public/FCCutils/eoscopy.py out_reco_edm4hep_2.parquet ${OUTPUTDIR}/pf_tree_${SEED}_2.parquet
python /afs/cern.ch/work/f/fccsw/public/FCCutils/eoscopy.py out_reco_edm4hep_3.parquet ${OUTPUTDIR}/pf_tree_${SEED}_3.parquet
python /afs/cern.ch/work/f/fccsw/public/FCCutils/eoscopy.py out_reco_edm4hep_4.parquet ${OUTPUTDIR}/pf_tree_${SEED}_4.parquet
python /afs/cern.ch/work/f/fccsw/public/FCCutils/eoscopy.py out_reco_edm4hep_5.parquet ${OUTPUTDIR}/pf_tree_${SEED}_5.parquet
python /afs/cern.ch/work/f/fccsw/public/FCCutils/eoscopy.py out_reco_edm4hep_6.parquet ${OUTPUTDIR}/pf_tree_${SEED}_6.parquet
python /afs/cern.ch/work/f/fccsw/public/FCCutils/eoscopy.py out_reco_edm4hep_7.parquet ${OUTPUTDIR}/pf_tree_${SEED}_7.parquet
python /afs/cern.ch/work/f/fccsw/public/FCCutils/eoscopy.py out_reco_edm4hep_8.parquet ${OUTPUTDIR}/pf_tree_${SEED}_8.parquet
python /afs/cern.ch/work/f/fccsw/public/FCCutils/eoscopy.py out_reco_edm4hep_9.parquet ${OUTPUTDIR}/pf_tree_${SEED}_9.parquet

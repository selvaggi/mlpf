# python scripts/auto_plot_results.py --datasets dr_05 --gpu 0 --path /eos/user/g/gkrzmanc/results/2024/E_PID_02122024_dr05_s6500_3layer_pid
# /eos/user/g/gkrzmanc/results/2024/E_PID_02122024_dr05_s6500
# python scripts/auto_plot_results.py --datasets dr_05 --gpu 0 --path  /eos/user/g/gkrzmanc/results/2024/PID_muons_fix_features_separate_PID_GATr_GT_clusters
# Track the models as the checkpoints are saved, and produce results for each model#
# python scripts/auto_plot_results.py --datasets dr_05 --gpu 0 --path  /eos/user/g/gkrzmanc/results/2024/E_PID_02122024_dr05_s6500_3layer_pid_GTClusters
import argparse
import os
import time
import subprocess
...
plotting_cmds = [""" /home/gkrzmanc/gatr/bin/python src/evaluation/refactor/plot_results.py --path {path} --preprocess class_correction,filt_LE_CH --output_dir filt_LE_CH_400bins_epsilon005  --mass-only """,
                 """ /home/gkrzmanc/gatr/bin/python src/evaluation/refactor/plot_results.py --preprocess class_correction --output_dir mass_plots_400bins_epsilon005 --mass_only """,
                 """ /home/gkrzmanc/gatr/bin/python src/evaluation/refactor/plot_results.py --path {path}  --output_dir mass_plots_400bins_epsilon005 """]

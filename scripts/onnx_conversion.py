...
hit_type =  torch.randn(10, 1).to("cpu")        # random categorical types
h_scalar = torch.randn(10, 2).to("cpu")                # last 2 columns will be used (e.g., e, p)
...
#     inputs,
#     filepath,
#     input_names=["pos_hits_xyz", "hit_type", "h_scalar"],
#     output_names=["output"],
#     opset_version=18,  
#     dynamic_axes={
#         "pos_hits_xyz": [0],
...
#         "h_scalar": [0],
#     },
#     # pos_hits_xyz=torch.zeros((10, 3)), hit_type=torch.zeros((10, 1)), h_scalar=torch.zeros((10, 2)),

...
for job in $(seq $startjob $stopjob); do
    source condor_CLD/run_sequence_CLD_train.sh /home/gmarchio/work/fcc/allegro/mlpf/mlpf config_spread_031224_fair.gun $nevents $job /home/gmarchio/work/fcc/allegro/mlpf/mlpf/output/$production tmp/$production &> logs/$production/job$job.log &
done

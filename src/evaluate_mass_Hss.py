...
if all_E:
    ...
    path_list = [
        "Eval_Hss_old_clustering_NeutralAvg/showers_df_evaluation/0_0_None_hdbscan.pt"
    ]
    path_pandora = "Eval_Hss_old_clustering_NeutralAvg/showers_df_evaluation/0_0_None_pandora.pt"

...
parser.add_argument('--class-edges', action='store_true', default=False,
...
parser.add_argument('-m', '--model-prefix', type=str, default='models/{auto}/networkss',
...
parser.add_argument('--clustering_and_energy_loss', '-clust_en', action='store_true', default=False)

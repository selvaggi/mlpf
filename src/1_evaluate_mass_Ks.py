...
if all_E:
    PATH_store = (
       #"/eos/user/g/gkrzmanc/eval_plots_EC/Ks_old_model_debug/reprod_plots_06_10_2024"
        ...
        "/eos/user/g/gkrzmanc/eval_plots_EC/Ks_old_model_debug_0810_100files/reprod_nofakes"
    )
    ...
    path_list = [
        ...
        "Ks_old_model_debug_0810_100files/showers_df_evaluation/0_0_None_hdbscan.pt"
    ]
    path_pandora = "Ks_old_model_debug_0810_100files/showers_df_evaluation/0_0_None_pandora.pt"
    path_pandora = "Ks_old_model_debug_0810_100files/showers_df_evaluation/0_0_None_pandora.pt"
...
def main():
    ...
    sd_hgb = sd_hgb[~pd.isna(sd_hgb.true_showers_E)]

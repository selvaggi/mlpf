...
DIR="/eos/experiment/fcc/ee/datasets/mlpf/condor/test/Tracking/"
mkdir ${DIR}
mkdir ${DIR}${SEED}
cd ${DIR}${SEED}
...
cp -r ${HOMEDIR}/condor_Tracking/make_pftree_clic_bindings.py .
cp -r ${HOMEDIR}/condor_Tracking/tree_tools.py .
...
echo "  "
# echo pwd
python make_pftree_clic_bindings.py out_reco_edm4hep_edm4hep.root tree.root True True

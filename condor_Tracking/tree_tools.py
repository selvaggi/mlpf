...
def initialize(t):
    ...
    hit_genlink = ROOT.std.vector("int")()
...
def store_track_hits(
    ...
    vxd_barrel_sim = "VertexBarrelCollection"
    vxd_endcap_sim = "VertexEndcapCollection"
    i_hits_sim = "InnerTrackerBarrelCollection"
    o_hits_sim = "OuterTrackerBarrelCollection"
    i_endcap_sim = "InnerTrackerEndcapCollection"
    o_endcap_sim = "OuterTrackerEndcapCollection"
